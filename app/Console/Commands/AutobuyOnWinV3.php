...
class AutobuyOnWinV3 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cryptobot:autobuy_on_win_v3 {max_date}';
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->strategy_name = 'autobuy_on_win_v3';
        $this->sell_strategy_name = 'autosell_on_lost_v3';
        ...
        $this->duration_win_to_buy = new \DateInterval('PT10M'); //2 min
