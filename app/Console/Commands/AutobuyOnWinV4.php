...
class AutobuyOnWinV4 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cryptobot:autobuy_on_win_v4 {max_date}';
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->strategy_name = 'autobuy_on_win_v4';
        $this->sell_strategy_name = 'autosell_on_lost_v4';
        ...
        $this->duration_win_to_buy = new \DateInterval('PT50M'); //2 min
    ...
    public function handle()
    {
        ...
        if(1)
        {
            ...
            foreach ($wallets as $wallet)
            {
                ...
                $candles = Candle_5m::where('close_time', '>', $last_transaction_date)
                ...
                if (!$always_go_up || $count_candles < ceil($this->duration_win_to_buy->format('%i') / 5))
                {
                    continue;
                }
