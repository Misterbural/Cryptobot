...
class AutosellOnLostV2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cryptobot:autosell_on_lost_v2 {max_date}';
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->strategy_name = 'autosell_on_lost_v2';
        $this->buy_strategy_name = 'autobuy_on_win_v2';
