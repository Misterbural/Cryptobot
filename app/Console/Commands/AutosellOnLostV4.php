...
class AutosellOnLostV4 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cryptobot:autosell_on_lost_v4 {max_date}';
    ...
    */
    ...
    public function __construct()
    {
        ...
        $this->strategy_name = 'autosell_on_lost_v4';
        $this->buy_strategy_name = 'autobuy_on_win_v4';
        
        //How much the lost or win need to be to take decision
        $this->percent_lost_to_sell = '0.02';

        //How long must be the period of loosing 
        $this->duration_lost_to_sell = new \DateInterval('PT3M'); //5 min
    }
