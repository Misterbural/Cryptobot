...
class testtamere extends Command
{
    ...
    */
    ...
    public function handle()
    {
        ...
        die();
         */
        $business_transaction = new BusinessTransaction('Poloniex');
        ...
        //var_dump($business_transaction->getBalances());
        //var_dump($business_transaction->getOrderBook('BTC-ETH'));
        var_dump($business_transaction->get_deposit_address('ETH'));
